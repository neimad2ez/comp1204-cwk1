...
\begin{tcolorbox}[colback=white, colframe=black, boxrule=0.5pt, arc=2mm, 
    title=Git Branch, fonttitle=\bfseries, listing only, listing options={language=sh, basicstyle=\ttfamily}]
\begin{verbatim}
git branch
\end{verbatim}
I used git branch to check
\end{tcolorbox}

\begin{tcolorbox}[colback=white, colframe=black, boxrule=0.5pt, arc=2mm, 
    title=Resolving Conflict, fonttitle=\bfseries, listing only, listing options={language=sh, basicstyle=\ttfamily}]
    I used text editor in VS Code to resolve the conflict.
\end{tcolorbox}
